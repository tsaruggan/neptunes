...
//            Album(title: "Days Before Rodeo", artist: self.artists[2], artwork: "travis_scott_album_art_2", header: "travis_scott_header_art"),
            ...
            Album(title: "CTRL (Unreleased)", artist: artists[3], artwork: "sza_album_artwork_1" ,header: "sza_header_art_1", isSingle: true)
        ]
        self.albums[0].addSongs(
            Song(title: "Talk is Cheap (feat. Aaliyah & Static Major)", isExplicit: true)
        )
